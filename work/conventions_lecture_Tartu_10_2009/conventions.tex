...
\begin{frame}[fragile]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frametitle{The Good Style}%
%
\begin{block}{We have just learned that}<1->
	A program must be \alert{understandable}.\\
	\uncover<2->{To everybody.}
\end{block}
\begin{block}{That's why we need }<3->
	Give understandable names to program elements!
\end{block}
\begin{block}{Example 3: Divisibility by 256}<4->
	Do not outsmart yourself!\\
	\uncover<5->{Use understandable code constructs.}
\end{block}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{frame}
\end{document}
