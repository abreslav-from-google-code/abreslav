 ...
 * <ul>
 *   <li>{@link astrans.impl.TransformationImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransformationImpl extends EObjectImpl implements Transformation {
	...
	public EList getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList(Action.class, this, AstransPackage.TRANSFORMATION__ACTIONS);
		}
		return actions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AstransPackage.TRANSFORMATION__ACTIONS:
