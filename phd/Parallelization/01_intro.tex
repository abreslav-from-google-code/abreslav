...
Here we deal with one of these models -- the \emph{Parallel Filtering Model} (\emph{PFM}) -- which is proposed in paper \cite{Amos:1996}. It defines four basic operations:
\begin{itemize}
