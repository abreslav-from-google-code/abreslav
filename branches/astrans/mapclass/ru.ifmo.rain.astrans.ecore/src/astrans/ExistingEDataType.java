 ...
 * <ul>
 *   <li>{@link astrans.ExistingEDataType#getEDataType <em>EData Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see astrans.AstransPackage#getExistingEDataType()
 * @model
 * @generated
 */
public interface ExistingEDataType extends EClassifierReference {
	 ...
	 * @see astrans.AstransPackage#getExistingEDataType_EDataType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link astrans.ExistingEDataType#getEDataType <em>EData Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
